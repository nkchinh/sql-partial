...
namespace SqlPartial
{
    ...
    /// <summary>
    /// Access modifiers for generated SQL properties.
    /// </summary>
    ...
    /// <summary>
    /// Configures the SQL generation for a class or interface.
    /// </summary>
    [System.AttributeUsage(System.AttributeTargets.Class | System.AttributeTargets.Interface)]
    public sealed class SqlPartialAttribute : System.Attribute
    {
        public AccessModifier PropertyModifier { get; }

        public SqlPartialAttribute(AccessModifier propertyModifier)
        {
...
";
        ...
        string modifier = "private")
    {
        ...
        foreach (var group in groups)
        {
            ...
            sb.AppendLine($"        {modifier} static readonly {stringsType} Sql{group.QueryName} = new {stringsType}(");
        ...
        bool supportsNullable)
    {
        ...
        sb.AppendLine("using SqlPartial;");
        if (config.UseSharedNamespace != null)
        {
            sb.AppendLine($"using {config.UseSharedNamespace};");
        }
